...
namespace ChallengePhunWithStrings
{
    public partial class Default : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            resultLabel.Text = new string(nameArray);
            */
            ...
            /* Answer2
            string[] rebelArray = names.Split(',');
            string result = "";
            for (int i = rebelArray.Length - 1; i >= 0; i--)
            {
                result += rebelArray[i] + ",";
            }
            ...
            */
            ...
            string[] rebelArray = names.Split(',');
            string result = "";
            for (int i = 0; i < rebelArray.Length; i++)
            {
                int padLeft = (14 - rebelArray[i].Length) / 2;
                string temp = rebelArray[i].PadLeft(rebelArray[i].Length + padLeft, '*');
