...
namespace MegaChallengeWar
{
    public class Battle
    {
        ...
        public string PerformBattle(Player player1, Player player2)
        {
            ...
            perfromEvaluation(player1, player2, player1Card, player2Card);
            return _sb.ToString();
        }
        ...
        private void perfromEvaluation(Player player1, Player player2, Card card1, Card card2)
        {
        ...
        private void war(Player player1, Player player2)
        {
            ...
            perfromEvaluation(player1, player2, warCard1, warCard2);
        }
